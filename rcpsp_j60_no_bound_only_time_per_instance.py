...
def main():
    ...
    output_file = result_dir / "j60_with_bound_900s.csv"
    ...
    local_path = "result/j60_with_bound_900s.csv"
    blob_name = f"results/{os.path.basename(local_path)}"  # ví dụ "results/j60_with_bound_900s.csv"
